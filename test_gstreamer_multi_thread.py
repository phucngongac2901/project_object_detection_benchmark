...
def main():
    ...
    cv2.namedWindow("Detections [Multi-Thread]", cv2.WINDOW_NORMAL)
    cv2.resizeWindow("Detections [Multi-Thread]", 960, 540)
    cv2.moveWindow("Detections [Multi-Thread]", 200, 50)
